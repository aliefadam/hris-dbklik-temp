...
@section('content')
    <div class="bg-white rounded-xl shadow-xl w-[55%] p-5">
        <form action="/owner/ganti-password" method="post" class="flex flex-col gap-3">
            @method('PUT')
            @csrf
            <div class="flex flex-col gap-2 w-full">
                ...
                <div class="relative w-full border-2 container-kata-sandi-lama rounded-lg px-3">
                    <input required type="password" class="w-[95%] outline-none rounded-lg text-[15px] py-2"
                        name="kata_sandi_lama" id="kata_sandi_lama"
