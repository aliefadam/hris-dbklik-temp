            ...
            <div class="flex mt-5 gap-10">
                ...
                <div class="flex-[1] flex flex-col gap-3 ">
                    <div class="flex flex-col">
                        ...
                        <span class="text-yellow-dbklik drop-shadow-md text-xl leading-none font-medium">26 Januari
                            2024</span>
                    </div>
                    <div class="flex flex-col">
                        <span class="text-dbklik text-[14px]">Tanggal Berakhir Kontrak</span>
                        <span class="text-yellow-dbklik drop-shadow-md text-xl leading-none font-medium">06 Mei 2024</span>
                    </div>
                    <div class="flex flex-col">
                        <span class="text-dbklik text-[14px]">Nomor Rekening</span>
                        <span class="text-yellow-dbklik drop-shadow-md text-xl leading-none font-medium">12345678</span>
                    </div>
                    <div class="flex flex-col">
                        <span class="text-dbklik text-[14px]">Divisi - Sub Divisi</span>
                        <span class="text-yellow-dbklik drop-shadow-md text-xl leading-none font-medium">IT -
                            Developer</span>
                    </div>
                    <div class="flex flex-col">
                        <span class="text-dbklik text-[14px]">Jabatan</span>
                        <span class="text-yellow-dbklik drop-shadow-md text-xl leading-none font-medium">Intern</span>
                    </div>
                    <div class="flex flex-col">
                        <span class="text-dbklik text-[14px]">Lokasi Kerja</span>
                        <span class="text-yellow-dbklik drop-shadow-md text-xl leading-none font-medium">Tenggilis</span>
                    </div>
                </div>
            </div>
        </div>
